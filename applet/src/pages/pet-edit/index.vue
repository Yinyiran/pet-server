      ...
      <view class="form-section">
        ...
        <view class="form-field">
          ...
          <view class="type-chips">
            <view
              class="type-chip"
              :class="{ active: petForm.type === 'cat' }"
              @tap="selectPetType('cat')"
            >
            ...
            <view
              class="type-chip"
              :class="{ active: petForm.type === 'dog' }"
              @tap="selectPetType('dog')"
            >
              <text class="chip-emoji">🐶</text>
            ...
            <view
              class="type-chip"
              :class="{ active: petForm.type === 'other' }"
              @tap="selectPetType('other')"
            >
              <text class="chip-emoji">🐰</text>
...
.delete-btn { font-size: 26rpx; color: $danger; width: 120rpx; text-align: right; }
.scroll-content { flex: 1; }

/* 扁平字段布局 — 匹配设计 pet-form */
...
/* 宠物类型选择 — 匹配设计 pet-type-chips */
.type-chips { display: flex; gap: 16rpx; }
.type-chip {
  flex: 1; text-align: center; padding: 20rpx 12rpx;
  ...
  &.active {
    border-color: $primary; background: $primary-light; color: #ea580c;
  }
}
.chip-emoji { font-size: 36rpx; display: block; margin-bottom: 4rpx; }
