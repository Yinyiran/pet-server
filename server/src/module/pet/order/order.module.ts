...
@Module({
  imports: [
    TypeOrmModule.forFeature([CartEntity, OrderEntity, OrderItemEntity, PaymentEntity, ProductEntity, PetUserEntity, PointsLogEntity, ConsumptionLogEntity, MemberLevelEntity]),
    CommissionModule,
  ],
